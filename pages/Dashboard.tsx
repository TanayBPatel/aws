            ...
            {activeTab === 'holdings' && (
                portfolio.positions.length > 0 ? (
                    portfolio.positions.map(position => (
                        ...
                        >
                            <div className="flex items-center gap-4">
                                <div className={`w-11 h-11 rounded-xl flex items-center justify-center text-lg font-bold relative overflow-hidden ${
                                    position.symbol === 'ETH' ? 'bg-[#627EEA]/20 text-[#627EEA]' :
