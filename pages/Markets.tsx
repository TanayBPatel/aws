                ...
                <div className="flex gap-2 overflow-x-auto no-scrollbar pb-2">
                    {FILTERS.map(filter => (
                        <button
                            ...
                            className={`px-5 py-2.5 rounded-full text-sm font-medium whitespace-nowrap transition-all duration-200 border border-transparent ${activeFilter === filter
                    ...
                    {trendingStocks.map(stock => (
                        ...
                        >
                            <div className="flex items-center gap-2 mb-3">
                                <div className={`w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold ${stock.symbol === 'ETH' ? 'bg-[#627EEA]/20 text-[#627EEA]' :
                            ...
                            <div className={`flex items-center gap-1 text-xs font-medium ${(stock.changePercent || 0) >= 0 ? 'text-accentLime' : 'text-error'
                                }`}>
                        ...
                        filteredStocks.map(stock => (
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-lg font-bold ${stock.symbol === 'ETH' ? 'bg-[#627EEA]/20 text-[#627EEA]' :
                                            stock.symbol === 'BTC' ? 'bg-[#F7931A]/20 text-[#F7931A]' :
                                ...
                                <div className="text-right">
                                    ...
                                    <div className={`flex items-center justify-end gap-1 text-xs font-medium ${(stock.changePercent || 0) >= 0 ? 'text-accentLime' : 'text-error'
                                        }`}>
