                ...
                <div className="flex-1 overflow-y-auto space-y-2 no-scrollbar">
                    ...
                    {filteredUsers.map(u => (
                        <button
                            ...
                            className={`w-full text-left p-3 rounded-xl flex items-center gap-3 transition-colors ${selectedUser?.user?.id === u.id
                    ...
                    <div className="max-w-4xl mx-auto space-y-6 animate-in slide-in-from-right duration-300">
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-2">
                                        ...
                                        <span className={`text-xs px-2 py-0.5 rounded-md flex items-center gap-1 ${selectedUser.user?.role === 'admin' ? 'bg-primary/20 text-primary' : 'bg-accentLime/20 text-accentLime'
                                            }`}>
                                            <CheckCircle size={12} />
                        ...
                        <div className="flex gap-4 border-b border-borderBase">
                            <button
                                ...
                                className={`pb-3 px-4 font-medium transition-colors ${activeTab === 'holdings'
                                        ...
                                        <div key={tx.id} className="bg-cardDark p-4 rounded-xl border border-borderBase">
                                            <div className="flex justify-between items-center">
                                                ...
                                                <div className="text-right">
                                                    ...
                                                    <span className={`text-[10px] px-1.5 py-0.5 rounded capitalize ${tx.status === 'completed' ? 'bg-accentLime/20 text-accentLime' : 'bg-error/20 text-error'
                                                        }`}>
                                                        {tx.status}
                                                    </span>
                                                </div>
