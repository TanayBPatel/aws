      ...
      <div className="bg-bgDark md:bg-cardDark w-full md:w-[400px] rounded-t-[32px] md:rounded-[32px] border-t md:border border-white/10 p-6 shadow-2xl relative">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            className={`w-full h-14 rounded-xl font-semibold text-lg flex items-center justify-center transition-transform active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed ${type === 'buy'
